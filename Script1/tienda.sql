...
-- -----------------------------------------------------
-- Borrado Logico y Fisico
-- -----------------------------------------------------

UPDATE sale SET annulment_at = NOW() WHERE sale_id = 1;
UPDATE sale SET annulment_at = NOW() WHERE sale_id = 3;

DELETE FROM sale WHERE sale_id = 2;
DELETE FROM sale WHERE sale_id = 5;

-- -----------------------------------------------------
-- Actualizacion de Productos y Proveedores
-- -----------------------------------------------------
UPDATE products
SET product_name = 'marcador', update_at = NOW()
WHERE product_id = 1;
UPDATE products
SET product_name = 'tajalapiz', update_at = NOW()
WHERE product_id = 2;
UPDATE products
SET product_name = 'cuaderno', update_at = NOW()
WHERE product_id = 3;

UPDATE provider
SET prov_name = 'Maraca como siempre SAS', update_at = NOW(), prov_id = 4
WHERE prov_id = 1;
UPDATE provider
SET prov_name = 'Sacale punta a la vida SAS', update_at = NOW(), prov_id = 5
WHERE prov_id = 2;
UPDATE provider
SET prov_name = 'Escribe para triunfar SAS', update_at = NOW(), prov_id = 6
WHERE prov_id = 3;